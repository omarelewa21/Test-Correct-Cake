var Menu = {
    ...
    addActionIconsToHeader: function () {
        ...
        if (User.info.isTeacher) {
            ...
            $.get('/users/getIsChatOpened',
                function(isChatOpened=false) {
                    if (isChatOpened) {
                        window.hsConversationsOnReady = [
                            () => Menu.openHubspotWidget().then( widget => widget.close() )
                        ];
                    };
            });
        }
