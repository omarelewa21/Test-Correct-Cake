...
var App = function() {
	...
	document.getElementById('btn-tool-freeform').ontouchdown	= function() { tool = 'freeform'; };


	document.getElementById('btn-tool-line').onclick			=
	document.getElementById('btn-tool-line').ontouchdown		= function() { tool = 'line'; };

	document.getElementById('btn-tool-arrow').onclick			=
	document.getElementById('btn-tool-arrow').ontouchdown		= function() { tool = 'arrow'; };

	document.getElementById('btn-tool-shape-circle').onclick		=
	document.getElementById('btn-tool-shape-circle').ontouchdown	= function() { tool = 'circle'; };

	document.getElementById('btn-tool-shape-rectangle').onclick		=
	document.getElementById('btn-tool-shape-rectangle').ontouchdown	= function() { tool = 'rectangle'; };
