...
App::uses('QtiImportCitoService', 'Lib/Services');

class QtiimportCitoController extends AppController
{
    public function beforeFilter()
    {
        $this->QtiImportService = new QtiImportCitoService();
    ...
    public function index()
    {
        ...
        foreach($data['subjects'] as $subject){
            $subjectList[] = (object) ['id' => getUUID($subject, 'get'),'name' => sprintf('%s (%s)',$subject['name'],$subject['abbreviation'])];
        }
