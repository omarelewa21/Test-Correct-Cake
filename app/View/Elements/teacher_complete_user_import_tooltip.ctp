<div id="questionmark_tooltip" onclick="showTooltip()"
    ...
    <div id="user_import_tooltip_div" style="   display: none;
                                  ...
                                  "
    >
        <p style="margin-top: .5rem">De importgegevens worden elke dag automatisch geüpdate vanuit <?= $type ? $type : 'het LVS systeem' ?>. Hieruit kunnen wij niet altijd alle informatie verkrijgen. Daarom vragen we om deze compleet te maken.</p>
        <a href="https://support.test-correct.nl/lvs_koppeling" target="_blank" class="text-button" style="text-decoration: none"><span style="margin-right: 10px">Lees meer hierover op de Kennisbank</span><?php echo $this->element('arrow') ?></a>
    </div>
    <script>
