<div id="prevent_logout_div" class="tat-content border-radius-bottom-0" style="padding-bottom: 0!important;padding-top: 2rem!important;">
    ...
    <div class="body1">
        ...
        <div style="border-radius: 10px; border:solid 1px var(--blue-grey);height: 400px; overflow: hidden;box-sizing: border-box">
            <iframe id="terms_iframe" src="https://www.test-correct.nl/wp-content/uploads/2021/06/Algemene-Voorwaarden-2021-The-Teach-and-Learn-Company-BV-Test-Correct-versie-20210618.pdf" frameborder="0" width="100%" height="100%"></iframe>
        </div>
<!--        <div class="flex" style="justify-content: center">-->
<!--            <span class="note">De knop ‘Accepteren’ activeert wanneer je de gehele tekst leest en naar beneden is gescrollt.</span>-->
<!--        </div>-->
        <div>
            <p class="body2 bold">Door middel van het accepteren bevestigt u dat u de <a href="https://www.test-correct.nl/algemene-voorwaarden/" style="text-decoration: underline">algemene voorwaarden</a> heeft ontvangen, gelezen en begrepen.</p>
        </div>
    </div>
</div>
