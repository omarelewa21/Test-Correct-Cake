        ...
        <div
            ...
            <table class="tableFixHead">
                ...
                <tr class="rotate_table_headings">
                    ...
                    <th width="120px"><div>Gecontrolleerd</div></th>
                </tr>
                </thead>
                <tbody>
                <?php $checkedCount = 0; ?>
                ...
                <?php if($checkedCount > 0) { ?>
                    <tr style="margin-top: 10px">
                        <td colspan="<?= 4+ count($education_levels);?>" style="text-align: center; border-bottom: 1px solid var(--blue-grey); padding: 1rem 0 0;width:100%;">
