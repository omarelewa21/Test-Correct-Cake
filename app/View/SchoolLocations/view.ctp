<div id="buttons">
    <? if ($isAdministrator && strtolower($school_location['customer_code']) !== 'tc-tijdelijke-docentaccounts'): ?>
        <a href="#" class="btn white" selid="BtnAddDefaultSectionsAndSubjects"
           onclick="SchoolLocation.addDefaultSectionsAndSubjects('<?= getUUID($school_location, 'get'); ?>');">
            <span class="fa fa-edit mr5"></span>
            <?= __("Voeg standaard vakken en secties toe") ?>
        </a>
        <a href="#" class="btn white"
           onclick="Popup.load('/school_locations/edit/<?= getUUID($school_location, 'get'); ?>', 1100);">
            <span class="fa fa-edit mr5"></span>
            <?= __("Wijzigen") ?>
        </a>
        <a href="#" class="btn white"
           onclick="SchoolLocation.delete(<?= getUUID($school_location, 'getQuoted'); ?>, 1, '<?= $return_route ?>');">
    ...
    <div class="block-content">
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td>
                    <span title="Totaal aantal text2speech licenties voor deze locatie"><?= $school_location['count_text2speech'] ?></span>
                </td>
            </tr>
            <tr>
                <th><?= __("Brin code") ?></th>
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <span class="btn small <?= $btnClass ?>" style="float:right;cursor:pointer"
                          onClick="updateSchoolLocation(<?= $allow ?>, 'allow_inbrowser_testing')"><?= $btnText ?></span>
                </td>
            ...
            <tr>
                ...
                <th><?= __("Nieuwe nakijken") ?></th>
                <td>
                    <?= $this->element('feature_setting_toggle', [
                        'attribute'   => 'allow_new_assessment',
                        'source'      => $school_location['feature_settings'],
                        'clickAction' => 'updateSchoolLocation'
                    ])
                    ?>
...
<div class="block">
    ...
    <div class="block-content">
                ...
                <tr>
                    ...
                    <td class="nopadding">
                        <a href="#" class="btn white pull-right dropblock-left"
                           onclick="Popup.load('/users/edit/<?= getUUID($manager, 'get'); ?>', 400);">
                            <span class="fa fa-folder-open-o"></span>
                        </a>
                    </td>
                    <td>
                        <a href="#" class="btn small red inline-block"
                           onclick="SchoolManager.delete('<?= getUUID($manager, 'get'); ?>');">
        ...
        <center>
            <a href="#" class="btn highlight inline-block mt15"
               onclick="Popup.load('/users/add/managers/location/<?= getUUID($school_location, 'get'); ?>', 400);">
...
<div class="block">
    ...
    <div class="block-content">
        ...
        <table class="table table-stiped">
            ...
            foreach ($school_location['licenses'] as $license) {
                ...
                <tr>
                    ...
                    <td class="nopadding">
                        <a href="#" class="btn white pull-right dropblock-left"
                           onclick="SchoolLocation.deleteLicense(<?= getUUID($school_location, 'getQuoted'); ?>,<?= getUUID($license, 'getQuoted'); ?>);">
                            <span class="fa fa-remove"></span>
                        </a>
                        <a href="#" class="btn white pull-right dropblock-left"
                           onclick="Popup.load('/school_locations/edit_licence/<?= getUUID($school_location, 'get'); ?>/<?= getUUID($license, 'get'); ?>', 400);">
                            <span class="fa fa-folder-open-o"></span>
                        </a>
                    </td>
                </tr>
        ...
        <center>
            <a href="#" class="btn highlight inline-block mt15"
               onclick="Popup.load('/school_locations/add_licence/<?= getUUID($school_location, 'get'); ?>', 400);">
                <span class="fa fa-plus"></span>
    ...
    <div class="block-content">
        ...
        foreach ($school_location['school_location_contacts'] as $contact) {
            ...
            <div style="float:left; width:300px; background: #f1f1f1; padding:10px; margin:3px;">
                ...
                <center>
                    <a href="#" class="btn small highlight inline-block"
                       onclick="Popup.load('/contacts/edit/<?= getUUID($contact['contact'], 'get') ?>', 400);">
                        <span class="fa fa-edit"></span>
                    </a>
                    <a href="#" class="btn small red inline-block"
                       onclick="Contact.delete('school_location', <?= getUUID($school_location, 'getQuoted'); ?>, '<?= $type ?>', '<?= getUUID($contact['contact'], 'get') ?>');">
                        <span class="fa fa-remove"></span>
                    </a>
                </center>
            </div>
        ...
        <center>
            <a href="#" class="btn highlight inline-block mt15"
               onclick="Popup.load('/contacts/add/school_location/<?= getUUID($school_location, 'get'); ?>', 400);">
                <span class="fa fa-plus"></span>
...
<div class="block">
    ...
    <div class="block-content">
        <table class="table table-striped">
            ...
            foreach ($ips as $ip) {
                ...
                <tr>
                    ...
                    <td><?= $ip['netmask'] ?></td>
                    <td>
                        <a href="#" class="btn white inline-block"
                           onclick="Ip.delete('<?= getUUID($school_location, 'get'); ?>', '<?= getUUID($ip, 'get'); ?>');">
                            <span class="fa fa-remove"></span>
                        </a>
                    </td>
                </tr>
        ...
        <center>
            <a href="#" class="btn highlight inline-block mt15"
               onclick="Popup.load('/school_locations/add_ip/<?= getUUID($school_location, 'get'); ?>', 400);">
                <span class="fa fa-plus"></span>
                <?= __("Ip toevoegen") ?>
            </a>
        </center>
