<div id="TestTakesExam">
    <div class="flex mb20 alignItemsCenter">
        <?= $this->element('testbank_tabs', array('tab' => 'exam')) ?>
...
<div class="block autoheight">
    <div class="block-content" id="testsContainter">
        ...
        $(document).ready(function () {
                ...
                var examTestsFirstTimeRun = false;
                if (typeof (examTestsFiltermanager) === 'undefined') {
                    examTestsFiltermanager = new FilterManager({
                        filterFields: [
                        ...
                        eventScope:'#TestTakesExam',
                        formPrefix: '#Test',
                        table: '#testsTable',
                        tablefy: {
                            'source' : '/exam_tests/load',
                            'filters' : '#TestIndexForm',
                            'container' : '#testsContainter'
                        },
                        filterKey: 'exam_tests',
                    });
                    examTestsFirstTimeRun = true;
                }



            examTestsFiltermanager.init(examTestsFirstTimeRun);
        });
