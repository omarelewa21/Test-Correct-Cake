...
<div class="popup-content">
    ...
    <div class="btn highlight pull-left  defaultMenuButton" onclick="Questions.addPopup(false, 'CompletionQuestion', '<?=$owner?>', '<?=$test_id?>','multi', '<?= $owner_id ?>');">
    <?= __("Selectie")?>
    </div>
    ...
    <div class="btn highlight pull-left  defaultMenuButton" onclick="Questions.addPopup(<?=$newDrawingQuestion?>, 'DrawingQuestion', '<?=$owner?>', '<?=$test_id?>','drawing', '<?= $owner_id ?>');">
    <?= __("Tekenen")?>
    </div>
