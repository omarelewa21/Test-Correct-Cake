<div id="AnalysesStudentOverview">
    ...
    <h1><?= __("Mijn studenten analyses")?></h1>
...
<div class="block autoheight">
    <div class="block-head"><?= __("Studenten overzicht")?></div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        analysesStudentOverviewFiltermanager = new FilterManager({
            filterFields: [
                {field: 'nameFirst', label: '<?= __("Voornaam")?>', type: 'text'},
                {field: 'name', label: '<?= __("Achternaam")?>', type: 'text'},
                {field: 'externalId', label: '<?= __("Studentnummer")?>', type: 'text'},
                {field: 'schoolLocationId', label: '<?= __("Locatie")?>', type: 'select'},
                {field: 'schoolClassId', label: '<?= __("Klas")?>', type: 'select'},
            ],
