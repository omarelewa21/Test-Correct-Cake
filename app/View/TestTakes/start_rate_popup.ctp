...
<div class="popup-content">
    ...
    <div id="random_options" style="display: none;">
        ...
        <center>
            <a href="#" class="btn highlight large inline-block mt15" onclick="Navigation.load('/test_takes/rate_teacher_random/<?=$take_id?>/' + $('#random_percentage_input').val()); Popup.closeLast();">Starten</a>
        </center>
    </div>
</div>
